:py:mod:`bittensor.extrinsics.serving`
======================================
...
.. py:function:: get_metadata(self, netuid: int, hotkey: str, block: Optional[int] = None) -> str


.. py:function:: publish_metadata(subtensor: bittensor.subtensor, wallet: bittensor.wallet, netuid: int, type: str, data: bytes, wait_for_inclusion: bool = False, wait_for_finalization: bool = True) -> bool
   ...
   :type netuid: int
   :param type: The data type of the information being submitted. It should be one of the following: ``'Sha256'``, ``'Blake256'``, ``'Keccak256'``, or ``'Raw0-128'``. This specifies the format or hashing algorithm used for the data.
   :type type: str
...
.. py:function:: serve_axon_extrinsic(subtensor: bittensor.subtensor, netuid: int, axon: bittensor.Axon, wait_for_inclusion: bool = False, wait_for_finalization: bool = True, prompt: bool = False) -> bool
...
.. py:function:: serve_extrinsic(subtensor: bittensor.subtensor, wallet: bittensor.wallet, ip: str, port: int, protocol: int, netuid: int, placeholder1: int = 0, placeholder2: int = 0, wait_for_inclusion: bool = False, wait_for_finalization=True, prompt: bool = False) -> bool
