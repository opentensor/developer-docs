:py:mod:`bittensor.extrinsics.registration`
===========================================
...
.. py:function:: burned_register_extrinsic(subtensor: bittensor.subtensor, wallet: bittensor.wallet, netuid: int, wait_for_inclusion: bool = False, wait_for_finalization: bool = True, prompt: bool = False) -> bool
...
.. py:function:: swap_hotkey_extrinsic(subtensor: bittensor.subtensor, wallet: bittensor.wallet, new_wallet: bittensor.wallet, wait_for_inclusion: bool = False, wait_for_finalization: bool = True, prompt: bool = False) -> bool
