...
.. py:module:: bittensor.core.extrinsics.serving
...
.. autoapisummary::
   ...
   bittensor.core.extrinsics.serving.do_serve_axon
   bittensor.core.extrinsics.serving.serve_extrinsic
   bittensor.core.extrinsics.serving.serve_axon_extrinsic
...
.. py:function:: do_serve_axon(self, wallet, call_params, wait_for_inclusion = False, wait_for_finalization = True)
   ...
   :param self: Subtensor instance object.
...
.. py:function:: serve_axon_extrinsic(subtensor, netuid, axon, wait_for_inclusion = False, wait_for_finalization = True)
...
.. py:function:: publish_metadata(self, wallet, netuid, data_type, data, wait_for_inclusion = False, wait_for_finalization = True)

   Publishes metadata on the Bittensor network using the specified wallet and network identifier.

   :param self: The subtensor instance representing the Bittensor blockchain connection.
   :type self: bittensor.core.subtensor.Subtensor
