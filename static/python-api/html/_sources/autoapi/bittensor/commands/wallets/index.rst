:py:mod:`bittensor.commands.wallets`
====================================
...
.. py:function:: _get_coldkey_ss58_addresses_for_path(path: str) -> Tuple[List[str], List[str]]
...
.. py:function:: get_wallet_transfers(wallet_address) -> List[dict]
