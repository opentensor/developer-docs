:py:mod:`bittensor.commands.senate`
===================================
...
.. py:class:: SenateLeaveCommand
   ...
   .. py:method:: _run(cli: bittensor.cli, subtensor: bittensor.cli)
      :staticmethod:
...
.. py:function:: display_votes(vote_data: bittensor.ProposalVoteData, delegate_info: bittensor.DelegateInfo) -> str


.. py:function:: format_call_data(call_data: bittensor.ProposalCallData) -> str
