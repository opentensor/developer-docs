...
.. py:class:: StreamingSynapse(/, **data)
   ...
   .. py:class:: BTStreamingResponse(model, *, synapse = None, **kwargs)
      ...
      :param model: A BTStreamingResponseModel instance containing
      ...
      :param synapse: The response Synapse to be used to update the response
                      headers etc.
   ...
   .. py:method:: create_streaming_response(token_streamer)
      ...
      :param token_streamer: A callable that takes a send function
