...
.. py:class:: Subtensor(network = None, config = None, _mock = False, log_verbose = False)
   ...
   .. py:method:: register(wallet, netuid, wait_for_inclusion = False, wait_for_finalization = True, max_allowed_attempts = 3, output_in_place = True, cuda = False, dev_id = 0, tpb = 256, num_processes = None, update_interval = None, log_verbose = False)
   ...
   .. py:method:: root_register(wallet, wait_for_inclusion = False, wait_for_finalization = True)
   ...
   .. py:method:: root_set_weights(wallet, netuids, weights, version_key = 0, wait_for_inclusion = False, wait_for_finalization = False)
   ...
   .. py:method:: transfer(wallet, dest, amount, wait_for_inclusion = True, wait_for_finalization = False, transfer_all = False, keep_alive = True)
