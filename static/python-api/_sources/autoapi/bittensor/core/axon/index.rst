...
.. py:class:: Axon(wallet = None, config = None, port = None, ip = None, external_ip = None, external_port = None, max_workers = None)
   ...
   :param max_workers: Used to create the threadpool if not passed, specifies the number of
   ...
   .. py:method:: attach(forward_fn, blacklist_fn = None, priority_fn = None, verify_fn = None)
      ...
      :param forward_fn: Function to be called when the API endpoint is accessed. It should have at least one
                         argument.
      :type forward_fn: Callable
      :param blacklist_fn: Function to filter out undesired requests. It should take the same
      ...
      :param priority_fn: Function to rank requests based on their priority. It should take the same
      ...
      :param verify_fn: Function to verify requests. It should take the same arguments as
   ...
   .. py:method:: serve(netuid, subtensor = None, certificate = None)
      ...
      :param netuid: The unique identifier of the subnet to register on. This ID is essential for the Axon to
                     correctly position itself within the Bittensor network topology.
      :type netuid: int
      :param subtensor: The subtensor connection to use for serving. If
   ...
   .. py:method:: verify_body_integrity(request)
      ...
      :raises JSONResponse: Raises a JSONResponse with a 400 status code if any of the hash comparisons fail, indicating
...
.. py:class:: AxonMiddleware(app, axon)
   ...
   :param app: An instance of the application where the middleware processor is
               used.
   ...
   .. py:method:: synapse_to_response(synapse, start_time, *, response_override = None)
      ...
      :param response_override: Instead of serializing the synapse, mutate the provided response object. This is only
...
.. py:function:: create_error_response(synapse)
   ...
   :param synapse: The synapse object containing details about the request and the
                   associated axon.
   :type synapse: bittensor.core.synapse.Synapse
...
.. py:function:: log_and_handle_error(synapse, exception, status_code = None, start_time = None)
   ...
   :param start_time: The timestamp marking the start of the processing, used to calculate process time.
                      Defaults to None.
